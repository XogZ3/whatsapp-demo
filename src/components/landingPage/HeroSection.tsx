  ...
  return (
    <div className="py-4 sm:py-14">
      <Container className="relative flex flex-col items-center justify-center gap-y-2 text-center sm:static">
        <div className="!mb-1 text-5xl tracking-tight opacity-0 sm:!mb-0 sm:text-7xl">
          <Balancer>
            {t('header_1')} <br />
        ...
        <h2 className="!mb-0 py-6 font-normal tracking-tight opacity-0">
          <Balancer>{t('subheader')}</Balancer>
        </h2>
        <ButtonFancy
          text={t('web_cta')}
          path="https://wa.me/971505072100"
          className="hidden min-w-[185px] text-lg font-semibold opacity-0 sm:block"
        />
      </Container>
      <DotPattern
        className={cn(
