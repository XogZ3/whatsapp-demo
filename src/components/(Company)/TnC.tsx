...
const TnC = () => {
  return (
    <Container className="" id="terms-of-use">
      <section className="terms-of-use">
        <h2 className="pb-10 text-4xl">TERMS OF USE</h2>
        <p>
          <b className="mb-5">
        ...
        <ol type="1">
          <li className="level-0">
            <b className="mb-5">Usage of Services</b>
            ...
            <ol type="1">
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    you shall be required to log on using your registered mobile
                    number/ username/email address/Facebook account and password
                  </li>
                  <li className="level-2">
                    you may upload/post: (i) content that either was created by
                    you entirely or legally belongs to you, or you have a
                    legally valid license which permits you to upload/post the
                    content; or (ii) your reviews, comments, reactions, etc., to
                    specific content on the Platform (the content/information
                    covered under (i) and (ii) above, the “Content”), and if in
                    the event we suffer any loss or damages on account of the
                    Content you have uploaded/posted belonging to another party
                    or such Content violating or infringing the rights of any
                    party, you shall be liable to indemnify us for such loss and
                    damages;
                  </li>
                  <li className="level-2">
                    ...
                    incorporate it in other works in any form, media, mode of
                    delivery or technology now known or later developed, (b)
                  ...
                  <li className="level-2">
                    ...
                    <ol type="i">
                      ...
                      <li className="level-3">harm minors in any way;</li>
                      <li className="level-3">
                      ...
                      <li className="level-3">
                        deceives or misleads the reader/viewer about the origin
                        of any information, or contains any information that is
                        grossly offensive or menacing in nature;
                      </li>
                      <li className="level-3">impersonate another person;</li>
                      <li className="level-3">
                        contain software viruses or any other computer code,
                        files or programmes that is designed to interrupt,
                  ...
                  <li className="level-2">
                    ...
                    party who has not consented to such content being uploaded
                    and accessible on the Platform or that it is violative of
                    the rights of any person who has not consented to such
                    Content being uploaded and accessible on the Platform; or
                    (ii) it comes to our attention that any of the Content
                    violates these Terms, we shall be entitled to remove such
                    content/block public access to such content either
                    temporarily or permanently, subject to the provisions of the
                    Indian Copyright Act, 1957, and the Information Technology
                    Act, 2000, and as we deem fit or in compliance with the
                    orders or directions of the court (if applicable) and we
                    shall have the right, at our discretion, to remove your
                    account, and in either case you shall have no right to make
                    any claims against us for removing or blocking such Content;
                  </li>
                  <li className="level-2">
                    you understand that we act as a technological platform
                    providing incidental, transient storage of the content
                    uploaded by you for the purpose of electronic transmission
                    to and access by members of the general public as understood
                    under the Indian Copyright Act, 1957 and as an intermediary
                    as understood under the Indian Information Technology Act,
                    2000.
                  </li>
                  <li className="level-2">
                    you shall be solely responsible for safeguarding your login
                    details including username and password and that we shall
                    have no liability whatsoever.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                Authority. You agree that you are permitted to use the Services
                under applicable law. If you are accessing an account(s) on
                behalf of the account owner (e.g., as an administrator,
              ...
              <li className="level-1 ">
                ...
                <ol type="i">
                  ...
                  <li className="level-2">
                    make available any Content that is harmful to children,
                    threatening, abusive, harassing, tortious, defamatory,
                    vulgar, obscene, libelous, invasive of another&lsquoa;s
                  ...
                  <li className="level-2">
                    impersonate any person or entity; or forge or manipulate
                    headers or identifiers to disguise the origin of any content
                    transmitted through the Service;
                  </li>
                  <li className="level-2">
                    make available any Content that you do not have the right to
                    make available or that infringes any patent, trademark,
                  ...
                  <li className="level-2">
                    make available viruses or any other computer code, files,
                    programs or Content designed to interrupt, destroy or limit
                    the functionality of the Services or affect other users; or
                  </li>
                  <li className="level-2">
                    interfere with or disrupt the Services or servers, systems
                    or networks connected to the Services in any way.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                Use of Services. You must follow any guidelines or policies
                associated with the use of the Services. You must not misuse or
                interfere with the Services or try to access them using a method
                other than the interface and the instructions that we provide.
                You may use the Services only as permitted by law. Unless
                otherwise expressly stated, you may not access or reuse the
                Services, or any portion thereof, for any commercial purpose.
                Without our express written consent, you may not (a) use any
                automated means to access the Platform or collect any
                information from the Platform (including without limitation
                robots, spiders or scripts), or (b) frame the Platform (or any
                part thereof), place pop-up windows over the Platform (or any
                part thereof) pages, or otherwise affect the display of part or
                area of the Platform.
              </li>
              <li className="level-1 ">
                Anti-Corruption Laws. You agree to comply with all applicable
                anti-corruption laws including laws that prohibit unlawful
                payments to anyone for a corrupt purpose in relation to these
                Terms.
              </li>
              <li className="level-1 ">
                Ownership and Reuse. Subject to these Terms, using the Services
          ...
          <li className="level-0">
            <b className="mb-5">Your Account Notices</b>

            <ol type="a">
              <li className="level-1 ">
                Account Information. You may need an account to use some
                ...
                user name, username, and your password(&quot;
                <b className="mb-5">Personal Data</b>&quot;). By providing us
                with the same, you acknowledge and accept that we have your
                consent for the collection and processing of such Personal Data.
                Our possession and use of Personal Data shall be in accordance
                with our Privacy Policy and Terms.
              </li>
              <li className="level-1 ">
                Access to Your Account. You are responsible for all activity
              ...
              <li className="level-1 ">
                ...
                the Services, telephone, or other reasonable means now known or
                hereafter developed. You consent to receive these notices by any
                and all of the foregoing means. You may not receive notices if
                you violate the Terms by accessing the Services in an
                unauthorized manner, and you will be deemed to have received any
                and all notices that would have been delivered had you accessed
          ...
          <li className="level-0">
            <b className="mb-5">
              Procedure for Copyright or Other Intellectual Property
              Infringement Claims or Claims of Violation of Other Rights
            </b>
            ...
            <ol type="i">
              <li className="level-1 ">
                ...
                delete such content, or disable, terminate, and/or take other
                ...
                (including you) shall have no right to make any claims against
                us for removing or blocking such content;
              </li>
              <li className="level-1 ">
                Reporting Claims of Copyright Infringement If you believe that
                your work (or the work of a third party on whose behalf you are
                entitled to act) has been copied in a way that constitutes
                copyright infringement, please file a copyright infringement
                notice with us. The notice should be in writing and include, in
                the order set out below, the following:
                <ol type="i">
                  <li className="level-2">
                    A statement that you have identified material on the
                    Platform that infringes your copyright (or infringes the
                    copyright of a third party on whose behalf you are entitled
                    to act);
                  </li>
                  <li className="level-2">
                    A description of the copyrighted work that you claim has
                    been infringed, which should include the type of work (such
                    as a book or a sound recording) and any relevant further
                    details (such as the title and date of publication, as
                    applicable);
                  </li>
                  <li className="level-2">
                  ...
                  <li className="level-2">
                    A description of the way in which the copyright material has
                    been infringed;
                  </li>
                  <li className="level-2">
                    A description of where the material that you claim is
                    infringing is located on our services (including a screen
                    shot and link to the same);
                  </li>
                  <li className="level-2">
                    Your address, telephone number, and email address so that we
                    may get in contact with you;
                  </li>
                  <li className="level-2">
                    A statement by you that you have a good faith belief that
                    the disputed use of the copyrighted work is not authorized
                    by the copyright owner (or by a third party who is legally
                  ...
                  <li className="level-2">
                    ...
                    authorized to act on the copyright owner&lsquo;s behalf.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                Reporting claims of violation of other personal rights If you
                believe that any Content on the Platform is violative of your
                (or that of someone you know and are authorized to act for)
                privacy or other personal rights please follow the following
                instructions.
                <ol type="i">
                  <li className="level-2">
                    A statement that you have identified material on the
              ...
              <li className="level-1 ">
                ...
                copyright or about your rights in the material, we suggest that
                you seek legal advice before reporting the material to us or
                sending us a counter-notice. Our response to your notice is
                regulated by applicable law. There may be negative consequences
                if you falsely allege copyright infringement or report material
                to us in bad faith. In addition, we may, in appropriate
                circumstances and at our discretion, disable, terminate, and/or
                take other appropriate steps relating to the accounts of users
          ...
          <li className="level-0">
            ...
            <ol type="a">
              <li className="level-1 ">
                We are constantly innovating, changing and improving the
                Services. We may, without notice, add or remove functionalities
                or features, create new limits to the Services, or temporarily
                or permanently suspend or stop a Service.
              </li>
              <li className="level-1 ">
                You can stop using the Services at any time. You may cancel and
                delete your account at any time here. However, you continuing to
                use the app constitutes your consent to us collecting data,
              ...
              <li className="level-1 ">
                ...
                account or impose limits on or restrict your access to parts or
                all of the Services at any time, without notice and for any
                reason, including, but not limited to, violation of these Terms,
                court order, or inactivity.
              </li>
              <li className="level-1 ">
                If your account is terminated, access to your username,
                password, and all related information, files, and content
                associated with your account may be terminated and your username
                may be recycled for use by others. However, some information may
                be retained in our files to prevent fraud, troubleshoot
                problems, assist with any investigations, enforce our Terms of
                Use and/or comply with legal requirements.
              </li>
              <li className="level-1 ">
                We may amend these Terms at any time by informing you of the
                amended terms via email to your email address. Such amendments
                will be effective when we email a notice of the amendments to
                you. Alternatively or additionally, we may display amended terms
                to you when you access the Platform, in which case such terms
                shall be effective when they are posted on the Platform.
              </li>
            </ol>
          </li>
          ...
          <li className="level-0">
            <b className="mb-5">Limitation of Liability</b>
            <ol type="a">
              <li className="level-1 ">
                ...
                ACCESS TO THE SERVICES, INCLUDING, BUT NOT LIMITED TO, LOSSES
                RESULTING FROM OR IN CONNECTION WITH: THE DELETION OF,
                ALTERATION OF, MIS-DELIVERY OF, OR FAILURE TO STORE DATA
                MAINTAINED OR TRANSMITTED BY THE SERVICES; THE LIMITING,
                SUSPENSION OR TERMINATION OF YOUR ACCOUNT; YOUR DOWNLOADING OR
                SHARING OF INFORMATION, INCLUDING PERSONAL INFORMATION, VIA THE
                SERVICES; THE UNAUTHORIZED ACCESS TO YOUR ACCOUNT OR ANY DATA
                MAINTAINED OR TRANSMITTED BY THE SERVICES; LINKS PROVIDED BY THE
          ...
          <li className="level-0">
            <b className="mb-5">Community Standards and Guidelines</b>
            <ol type="i">
              <li className="level-1 ">
                Our primary objective is to empower people to discover and
              ...
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    ...
                    other users discover, and engage with you based on similar
                    interests.
                  </li>
                  <li className="level-2">
                    The User is encouraged to post and share your moments at
                    restaurants, salons, clubs, and other interesting places in
                    your locality, with their stories in caption. Please always
                    add the relevant location in context to the post.
                  </li>
                  <li className="level-2">
                    Putting up posts which capture the essence of the place and
                    their experiences will help your fellow users understand the
                    outlet better.
                  </li>
                  <li className="level-2">
                    The User is also encouraged to ask questions about different
                    places and experiences and get feedback and reviews from
                    co-users on the platform.
                  </li>
                  <li className="level-2">
                    Liking posts randomly (people at their homes, not in proper
                    dresses, hazy pictures, not looking at the camera) is
                    discouraged.
                  </li>
                  <li className="level-2">
                    Comments to a post not pertaining to or related to the post,
                    person, place or their review on the experience are also
                    discouraged. Please try and make the comments interesting so
                    that other users also look up to you and want to stay in
                    touch with you.
                  </li>
                  <li className="level-2">
                    Posting any misleading links in comments, and content that
                    expresses obscenity, vulgarity, hatred, racism, or
                    gratuitous violence is prohibited, and will face
                    disciplinary action, including but not limited to permanent
                    ban.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                ...
                <ol type="a">
                  ...
                  <li className="level-2">
                    ...
                    layout of this website or mobile application, individual
                    elements of the website or mobile application design, or our
                    logos without our express written permission.
                  </li>
                </ol>
              </li>
            </ol>
          ...
          <li className="level-0">
            ...
            <p>
              ...
              records and generally maintain your accounts with us, display
              content and recommend merchandise and services that might be of
              interest to you. We also use this information to improve our
              platform, prevent or detect fraud or abuses of our website and
              enable you to have a grand experience. We use Cookies and Device
              Data that allow us to connect your activity within the Platform
              with other information we store about you in your profile or as
              related to your interactions with the Site. We collect information
              ...
              collect to customise our services for you, including providing
              recommendations and personalised content. We will ask for your
              explicit consent to share any sensitive personal information.
              Additionally, we will also ask for your consent before using your
            ...
            <ol type="A">
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    ...
                    download and register the Application.
                  </li>
                  <li className="level-2">
                    When you register with us and use the Application, you
                    generally provide (a) your name, email address, phone number
                    and other registration information; (b) transaction-related
                    information, such as when you make purchases and/or upload a
                    selfie, respond to any offers, or download or use any
                    applications from us; (c) information you provide us when
                    you contact us for help; (d) any other information you enter
                    into our system when using the Application, such as contact
                    information and project management information.
                  </li>
                  <li className="level-2">
                    The Application may also collect certain information
                    automatically, including, but not limited to, the type of
                    mobile device you use, your mobile devices unique device ID,
                    circle of the IP address of your mobile device, your mobile
                    operating system, the type of mobile Internet browsers you
                    use, and information about the way you use the Application.
                  </li>
                  <li className="level-2">
                    We may use the information you provided us to contact you
                    from time to time to provide you with important information,
                    required notices and marketing promotions and also improve
                    your activities on our platform such as posting in our
                    forums, liking posts, sending feedback, and responding to
                  ...
                  <li className="level-2">
                    We may also use your personal information to improve our
                    services and user experience on the Application, to enforce
                    our legal rights as permitted under law, and otherwise with
                    your consent.
                  </li>
                  <li className="level-2">
              ...
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    ...
                    about things near your device, such as Wifi Access Points,
                    cell towers and Bluetooth enabled devices.
                  </li>
                  <li className="level-2">
                    We may request access or permission to and track
                    location-based information from your mobile device while you
                    are using the Application, to provide location-based
                    services. We may also collect the precise location of your
              ...
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    Please note that no other contacts information other than
                    the phone numbers and thereto attached names and email
                  ...
                  <li className="level-2">
                    When you turn on phone contacts uploading, information from
                    your phone contacts will be continuously uploaded. This
                    makes it easier to find the people you already know.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                ...
                <ol type="a">
                  ...
                  <li className="level-2">
                    ...
                    debit card number to the appropriate credit / debit card
                    company or the concerned bank for processing of the
                    transaction.
                  </li>
                  <li className="level-2">
              ...
              <li className="level-1 ">
                ...
                <ol type="a">
                  ...
                  <li className="level-2">
                    ...
                    Information unless consent to the same has been specifically
                    withdrawn by the User.
                  </li>
                  <li className="level-2">
                    We will not share your contact information at any point
                    without your prior content, but your selfies, comments and
                    other actions specific to our system might be visible to
                    other users and merchants on the platform. However, without
                    your prior consent such users will not have access to your
                    contact information. You, as a User, have the ability, to
                    remove your information from the system and to restrict our
                    access and use of your personal data;
                  </li>
                  <li className="level-2">
                    We shall provide all information that is to be provided when
                    required by law, such as to comply with a summons, or
                    similar legal process as well as when we believe in good
                  ...
                  <li className="level-2">
                    ...
                    this privacy statement and apply data protection measures,
                    at least equal to those set out below in the section “Data
                    Security Measures”.
                  </li>
                  <li className="level-2">
                    If in the event that Samast Technologies is involved in a
                    merger, acquisition, or sale of all or a portion of its
                    assets, you will be notified via email and/or a prominent
                    notice on our Web site of any change in ownership or uses of
                    this information, as well as any choices you may have
                    regarding this information.
                  </li>
                  <li className="level-2">
                    We also may share data that is not linkable to a particular
                    consumer or device (for example, information that has been
                    aggregated with other records) for general business
                    purposes.
                  </li>
                </ol>
              </li>
              ...
              <li className="level-1 ">
                ...
                <ol type="a">
                  ...
                  <li className="level-2">
                    We will retain Automatically Collected information for up to
                    24 months and thereafter may store it in aggregate.
                  </li>
                  <li className="level-2">
                  ...
                  <li className="level-2">
                    ...
                    may be required in order for the Application to function
                    properly.
                  </li>
                </ol>
              </li>
              <li className="level-1 ">
                ...
                <ol type="a">
                  <li className="level-2">
                    ...
                    tracking technologies on the Application to help customize
                    the Application and improve your experience. When you access
                    the Application, your personal information is not collected
                    using tracking technology. Most browsers are set to accept
                  ...
                  <li className="level-2">
                    ...
                    and applications of interest, including advertisements and
                    external services, that are not affiliated with us. Once you
                    have used these links to leave the Application, any
                    information you provide to these third parties is not
                    covered by this Privacy Policy, and we cannot guarantee the
                    safety and privacy of your information. Before visiting and
                    providing any information to any third-party websites, you
                    should inform yourself of the privacy policies and practices
                    (if any) of the third party responsible for that website,
                    and should take those steps necessary to, in your
                    discretion, protect the privacy of your information. We are
              ...
              <li className="level-1 ">
                Release of User Information: We release account and other
                personal information when we believe release is appropriate to
                comply with applicable law; enforce or apply our Conditions of
                Use and other agreements; or protect the rights, property or
                safety of merchants, our users or others. This includes
                exchanging information with other companies, organisations,
                government or regulatory authorities for fraud protection and
                credit risk reduction. Obviously, however, this does not include
                selling, renting, sharing or otherwise disclosing personally
                identifiable information from customers for commercial purposes
                in a way that is contrary to the commitments made in this
                Privacy Notice
              </li>
              <li className="level-1 ">
                ...
                <ol type="a">
                  ...
                  <li className="level-2">
                    ...
                    with merchant to the extent you have purchased or redeemed a
                    voucher for goods or services offered by a merchant or
                    participated in an offer, rewards, contest or other activity
                    or program sponsored or offered through us or the Sellers on
              ...
              <li className="level-1 ">
                User Opt-out: The User can choose to stop all collection of
              ...
              <li className="level-1 ">
                ...
                age verification at the time of registration, directly or
              ...
              <li className="level-1 ">
                ...
                processed; and (c) brief summary of the Terms. You may also
                contact us if you wish any respective information to be
                corrected or removed or deleted.
              </li>
            </ol>
          </li>

          <li className="level-0">
            <b className="mb-5">Direct Payment Facility</b>
            <ol type="a">
              <li className="level-1 ">
          ...
          <li className="level-0">
            ...
            <ol type="a">
              ...
              <li className="level-1 ">
                The reward programme is being offered at our discretion and we
                reserve the right to cancel or discontinue the reward programme
                and/or change the terms of the programme, without any liability
                whatsoever to you. You agree that you shall have no rights or
                claims of whatsoever nature against us in such event.
              </li>
              <li className="level-1 ">
          ...
          <li className="level-0">
            <b className="mb-5">About these Terms</b>
            <ol type="i">
              <li className="level-1 ">
                ...
                additional terms will control solely for that conflict or
                inconsistency.
              </li>
              <li className="level-1 ">
                Modification of the Terms. We may modify the Terms from time to
                time to keep in compliance with current law as well any future
                legislations that aim to protect information and privacy. Unless
                we indicate otherwise, modifications will be effective as of the
                date they are posted on this page or any successor page. You
                should look at the Terms regularly. We will provide notice (in
                accordance with Section 3(c) above) of material modifications.
              </li>
              <li className="level-1 ">
                Continued Use of the Services. You may stop using the Services
          ...
          <li className="level-0">
            <b className="mb-5">Cancellation and refund policy:</b>
